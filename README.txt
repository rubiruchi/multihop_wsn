Each of the wireless sensor nodes was programmed to be able to 
monitor their environment with sensors, transmit their data, and forward data from other nodes if 
necessary.
